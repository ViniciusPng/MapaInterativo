...
mapbox_access_token = 'sk.eyJ1IjoidmluaWNpdXNwbmciLCJhIjoiY2xoM295aGI1MHA3ZTNlbjRidjhhZnV6ZSJ9.EZT38zh7Cqw8yjGVrq9DCg'

df = pd.read_csv("../../MapProject/finalrecycling.csv")
